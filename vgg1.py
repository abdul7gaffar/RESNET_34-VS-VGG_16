...
from keras.layers import Input, Dropout, Flatten, Conv2D, MaxPooling2D, Dense, Activation, Reshape, AveragePooling2D
...
def vgg16():
    ...
    model.add(AveragePooling2D(data_format="channels_last", pool_size=(2, 2)))
